      ...
      <div className="edit-task">
        ...
        >
          <Card.Header>
            ...
            <Badge pill variant={this.state.color}>
              {this.state.category}
            </Badge>
          </Card.Header>
          <Card.Body>
        ...
        <Form>
          ...
          <Form.Group>
            ...
            >
              ...
              <option id="danger" value="Bug">
                Bug
              </option>
              <option id="success" value="Feature">
                Feature
              </option>
              <option id="warning" value="TechDebt">
                Tech Debt
              </option>
              <option id="primary" value="Improvement">
                Improvement
              </option>
              <option id="info" value="Research">
                Research
              </option>
            </Form.Control>
          </Form.Group>
        ...
        <div className="buttons">
          ...
          <Button
            ...
            type="submit"
            onClick={() => {
              this.onDelete(this.state.id, "isDeleted");
            }}
          >
            Delete
          </Button>
